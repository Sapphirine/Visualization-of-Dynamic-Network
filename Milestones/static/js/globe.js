...
var urls = [
  '/static/assets/pos-x.png',
  '/static/assets/neg-x.png',
  '/static/assets/pos-y.png',
  '/static/assets/neg-y.png',
  '/static/assets/pos-z.png',
  '/static/assets/neg-z.png'
];
...
function addEarth() {
  ...
  uniforms['texture'].value = THREE.ImageUtils.loadTexture('/static/assets/world.jpg');
  ...
  earthMesh = new THREE.Mesh(spGeo, material);
  scene.add(earthMesh);

// var globe = new THREE.Object3D ();
// // 	globe.scale.set (250, 250, 250);
// 	scene.add (globe);
//   var blue = new THREE.MeshBasicMaterial( { color: 0x00FFFF} );
//  var radius = 600
// 	var geometry = new THREE.SphereGeometry(radius, 30, 15);
// 	earthMesh = new THREE.Mesh (geometry, blue);
// 	scene.add( earthMesh );
...
//   console.log(data);
  ...
  var point = latLonToVector3(lat, lon);
  addBeacon( point, data );
}
...
function addCountries(){
    var gold = new THREE.MeshBasicMaterial( { color: 0xFFFFFF, transparent: true, opacity: 0.2} );
...
//     console.log( geoInfo[name].mesh.geometry);
  }
//   console.log(geoInfo["United States"].mesh.geometry);
}
